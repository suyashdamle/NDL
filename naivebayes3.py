...
def get_data(parameter):
    ...
    limit=6500000
    offset=0
    maxrows_train_data=46280401  #define value
    maxrows_test_data=15431863    #define
...
def main():
    ...
    score = accuracy_score(test_targets, predictions,normalize=True)
    print "score=", score
